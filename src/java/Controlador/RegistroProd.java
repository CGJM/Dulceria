...
import dulceria_53.Empleado;
import dulceria_53.Producto;
 ...
 * @author crist
 */
@WebServlet(name = "RegistroProd", urlPatterns = {"/RegistroProd"})
public class RegistroProd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Producto dulce;
            String id = request.getParameter("idP").trim();
            ...
            dulce = new Producto(id, precio, cantidad, nombre);
            if (auxiliar.Alta(dulce, persona)) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RegistroProd.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
