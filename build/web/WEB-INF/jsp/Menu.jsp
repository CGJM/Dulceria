    ...
    <body class="text-center">
        ...
        <%
            try {
                ...
                //out.print("<a type='submit' href='./WEB-INF/jsp/logout.jsp'>Salir</a>");

            } catch (Exception e) {
                session.setAttribute("msg", "Porfavor, autentifiquese");
                response.sendRedirect("./WEB-INF/jsp/index.jsp");
            }
        %>
        <br>
        <a type='submit' class="btn btn-outline-danger my-2 my-sm-4 col-md-1"  href="logout">Salir</a>
